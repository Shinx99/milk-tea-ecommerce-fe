    ...
    <div class="card shadow-sm border-0">
      <div class="card-header bg-white d-flex justify-content-between align-items-center">
        ...
        <div style="max-width: 350px; width: 100%;">
          <input v-model="customerState.keyword" type="search" class="form-control" placeholder="Tìm khách hàng..." />
        </div>
        ...
        <div class="d-flex align-items-center gap-2 ms-3">
          ...
          <button type="button" class="btn btn-primary btn-sm" @click="goToRegister">
            + Thêm khách hàng
          </button>
        </div>
      </div>
        ...
        <div class="table-responsive">
          <table class="table table-hover table-striped align-middle mb-0">
            ...
            <tbody>
              ...
              <tr v-for="(cus, index) in customers" :key="cus.id" @dblclick="startEdit(cus), openModal()"
                ...
                <td>{{ cus.phone }}</td>
                <td>
                  <span class="badge" :class="cus.is_active
                    ? 'badge bg-success'
                    : 'badge bg-danger'">
                ...
                <td class="text-center">
                  ...
                  <button class="btn btn-sm btn-outline-danger" @click="removeCustomer(cus.id)">
      ...
      <nav v-if="!customerState.isLoading && customerState.totalPages > 0" aria-label="Page navigation" class="mt-4">
        <ul class="pagination justify-content-center align-items-center">
          ...
          <li class="page-item" :class="{ disabled: customerState.page === 0 }">
            <button class="page-link bg-primary text-white rounded-pill px-3 py-1 border-0" @click.prevent="prevPage"
              :disabled="customerState.page === 0" aria-label="Previous">
          ...
          <li class="page-item" :class="{ disabled: customerState.page >= customerState.totalPages - 1 }">
            <button class="page-link bg-primary text-white rounded-pill px-3 py-1 border-0" @click.prevent="nextPage"
              :disabled="customerState.page >= customerState.totalPages - 1" aria-label="Next">
              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                  <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="checkActive" v-model="newCustomer.active" />
