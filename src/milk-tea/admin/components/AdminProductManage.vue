                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td>
                                ...
                                <img 
                                    v-if="prod.imageUrl && prod.imageUrl.length > 0"
                                    :src="prod.imageUrl[0]"
                                    alt="Ảnh sản phẩm"
            ...
            >
                <form class="mt-2 row g-3" @submit.prevent="submitProduct">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" min="0" class="form-control" id="productPrice" v-model.number="product.price" required />
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="productDescription" rows="2" v-model="product.description"></textarea>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group mb-2">
                            ...
                            />
                            <button class="btn btn-outline-secondary" type="button" @click="addImageUrl" :disabled="!newImageUrl.trim()">
                                Thêm Link
                            </button>
                        </div>
                        ...
                        >
                            ...
                            <div v-for="(img, idx) in product.imageUrl" :key="idx" class="position-relative" style="width: 80px; height: 80px">
                                <img
                                    :src="img"
                                    alt="image"
                                    class="img-thumbnail"
